...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _jsxFileName="/Users/kenwheeler/Projects/victory-pie/src/components/victory-pie.js";var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(2);var _react2=_interopRequireDefault(_react);
	var _d3Shape=__webpack_require__(3);var _d3Shape2=_interopRequireDefault(_d3Shape);
	var _lodash=__webpack_require__(5);
	var _victoryCore=__webpack_require__(7);
	...
	_this.getEventState=_victoryCore.Helpers.getEventState.bind(_this);return _this;}_createClass(VictoryPie,[{key:"getColor",value:function getColor(
	...
	return colors[index%colors.length];}},{key:"getRadius",value:function getRadius(
	...
	2;}},{key:"getLabelPosition",value:function getLabelPosition(
	...
	outerRadius(radius).
	innerRadius(innerRadius);}},{key:"getLabelText",value:function getLabelText(
	...
	return (0,_lodash.isFunction)(props.labels)?props.labels(datum):datum.xName||datum.x;}},{key:"getSliceFunction",value:function getSliceFunction(
	...
	value(function(datum){return datum.y;});}},{key:"renderData",value:function renderData(
	
	
	props,calculatedProps){var _this2=this;var 
	style=calculatedProps.style;var colors=calculatedProps.colors;var pathFunction=calculatedProps.pathFunction;var labelPosition=calculatedProps.labelPosition;var data=calculatedProps.data;
	...
	var dataStyles=(0,_lodash.omit)(slice.data,["x","y","label"]);
	var sliceStyle=(0,_lodash.defaults)({},{fill:fill},style.data,dataStyles);
	var dataProps=(0,_lodash.defaults)(
	{},
	_this2.getEventState(index,"data"),
	...
	var sliceComponent=_react2.default.cloneElement(props.dataComponent,(0,_lodash.assign)(
	{},dataProps,{events:_victoryCore.Helpers.getPartialEvents(dataEvents,index,dataProps)}));
	...
	(0,_lodash.assign)({padding:0},style.labels),
	dataProps.datum);
	
	var labelProps=(0,_lodash.defaults)(
	{},
	_this2.getEventState(index,"labels"),
	...
	var sliceLabel=_react2.default.cloneElement(props.labelComponent,(0,_lodash.assign)({
	events:_victoryCore.Helpers.getPartialEvents(labelEvents,index,labelProps)},
	labelProps));
	return _this2.renderSlice(index,sliceComponent,sliceLabel);}
	
	return sliceComponent;});}},{key:"getCalculatedProps",value:function getCalculatedProps(
	
	
	
	props){
	var style=_victoryCore.Helpers.getStyles(props.style,defaultStyles,"auto","100%");
	var colors=Array.isArray(props.colorScale)?
	props.colorScale:_victoryCore.Style.getColorScale(props.colorScale);
	...
	return {style:style,colors:colors,padding:padding,radius:radius,data:data,labelPosition:labelPosition,pathFunction:pathFunction};}},{key:"renderSlice",value:function renderSlice(
	
	
	
	index,component,label){
	return (
	_react2.default.createElement("g",{key:"slice-group-"+index,__source:{fileName:_jsxFileName,lineNumber:387}},
	component,
	label));}},{key:"renderGroup",value:function renderGroup(
	
	
	
	
	style,xOffset,yOffset,calculatedProps){
	return (
	_react2.default.createElement("g",{style:style,transform:"translate("+xOffset+", "+yOffset+")",__source:{fileName:_jsxFileName,lineNumber:396}},
	this.renderData(this.props,calculatedProps)));}},{key:"renderStandalone",value:function renderStandalone(
	...
	this.props.events.parent,{__source:{fileName:_jsxFileName,lineNumber:404}}),
	...
	return (
	_react2.default.createElement(_victoryCore.VictoryTransition,{animate:this.props.animate,animationWhitelist:whitelist,__source:{fileName:_jsxFileName,lineNumber:424}},
	_react2.default.createElement(this.constructor,this.props)));}
	
	
	
	
	var calculatedProps=this.getCalculatedProps(this.props);var 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _victoryAnimation = __webpack_require__(121);
	...
	var _victoryLabel = __webpack_require__(127);
	...
	var _victoryTransition = __webpack_require__(132);
	...
	var _transitions = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _property2 = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseProperty = __webpack_require__(11),
	    basePropertyDeep = __webpack_require__(12),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createWrapper = __webpack_require__(18),
	    getHolder = __webpack_require__(25),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assignMergeValue = __webpack_require__(40),
	    baseClone = __webpack_require__(42),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stack = __webpack_require__(31),
	    ...
	    copyArray = __webpack_require__(48),
	    copySymbols = __webpack_require__(49),
	    getAllKeys = __webpack_require__(52),
	    getTag = __webpack_require__(56),
	    initCloneArray = __webpack_require__(70),
	    initCloneByTag = __webpack_require__(71),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stubArray = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cloneArrayBuffer = __webpack_require__(72),
	    ...
	    cloneSet = __webpack_require__(80),
	    cloneSymbol = __webpack_require__(83),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3Ease = __webpack_require__(122);
	
	var _d3Ease2 = _interopRequireDefault(_d3Ease);
	
	var _d3Interpolate = __webpack_require__(123);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isPlainObject2 = __webpack_require__(97);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _identity2 = __webpack_require__(130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pick2 = __webpack_require__(133);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayReduce = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _jsxFileName="/Users/kenwheeler/Projects/victory-pie/src/components/slice.js";var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(2);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var 
	...
	style:props.style},
	props.events,{__source:{fileName:_jsxFileName,lineNumber:15}})));}},{key:"render",value:function render()
